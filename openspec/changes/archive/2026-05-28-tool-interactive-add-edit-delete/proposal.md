...
- **Modified files**:
  ...
  - `fsuipc-test-client/OffsetParser.cs` — added `WriteFile` method, extended address range to 0xFFFFF
  - `fsuipc-test-client/BatchMode.cs` — address format updated for >0xFFFF addresses
